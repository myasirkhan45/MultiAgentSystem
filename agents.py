...
# LLMs
# ==========================================
# NOTE: search/reader agents just need to summarize findings concisely,
# so a smaller max_tokens is fine for them. The writer agent needs to
# produce a full 500-650 word report, so it gets its own LLM instance
# with a much higher max_tokens ceiling — otherwise the report gets
# hard-cut mid-sentence once the token budget runs out.
#
